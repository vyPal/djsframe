...
class Argument {
	 ...
	 * @param {FrameMessage} msg - Message that triggered the command
	 ...
	 * @param {Message} originalMsg - Message that triggered the command
	 * @param {?Message} [currentMsg=originalMsg] - Current response message
	 ...
	 * @param {FrameClient} client - Client to validate
	 ...
	 * @param {FrameClient} client - Client to use the registry of
